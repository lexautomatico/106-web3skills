                  ...
                  {!isMobile && (
                    ...
                    >
                      <figure className={cx(classes.figure, classes.graphic)}>
                        <img src={imgAPI.saas[24]} alt="illustration" />
                      </figure>
                    </Parallax>
                  )}
                  <ParallaxMedium />
            ...
            <Grid container>
              ...
              <Grid item md={6} xs={12}>
                <div className={classes.illustrationRight}>
                  ...
                  >
                    <figure className={cx(classes.figure, classes.screen)}>
                      <img src={imgAPI.saas[13]} alt="screen" />
                    </figure>
                  </Parallax>
                  {!isMobile && (
                    <Parallax
              ...
              <Grid container spacing={6}>
                ...
                <Grid item md={10} xs={12}>
                  <Tabs
                    ...
                    centered
                  >
                    <Tab classes={{ root: classes.tabLabel, selected: classes.selected }} label="P2P Content Storage" />
                    <Tab classes={{ root: classes.tabLabel, selected: classes.selected }} label="Public Blockchains" />
                    <Tab classes={{ root: classes.tabLabel, selected: classes.selected }} label="Digital Artifacts" />
                  </Tabs>
                  <div className={classes.tabContent}>
                    {value === 0 && (
                      <section>
                        ...
                        <div className={classes.illustrationCenter}>
                          <figure className={cx(classes.figure, classes.screen)}>
                            <img src={imgAPI.saas[25]} alt="screen" />
                          </figure>
                        </div>
                      </section>
                    )}
                    {value === 1 && (
                      <section>
                        ...
                        <div className={classes.illustrationCenter}>
                          <figure className={cx(classes.figure, classes.screen)}>
                            <img src={imgAPI.saas[26]} alt="screen" />
                          </figure>
                        </div>
                      </section>
                    )}
                    {value === 2 && (
                      <section>
                        ...
                        <div className={classes.illustrationCenter}>
                          <figure className={cx(classes.figure, classes.screen)}>
                            <img src={imgAPI.saas[27]} alt="screen" />
                          </figure>
                        </div>
                      </section>
                    )}
